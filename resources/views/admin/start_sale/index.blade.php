            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-md-flex justify-content-between align-items-center mb-20">
                        <h6 class="card-title mb-0">{{ __('content.sales') }}</h6>
                        <div>
                            <a href="{{ url('admin/start-sale/create') }}" class="btn btn-primary float-right mb-3">+ {{ __('content.start_sale') }}</a>
                        </div>
                    </div>
                    @if (count($start_sales) > 0)
                        <div>
                        ...
                        @else
                            <form onsubmit="return btnCheckListGet()" action="{{ route('start-sale.destroy_checked') }}" method="POST">
                                @method('DELETE')
                                @csrf
                                @endif
                        ...
                        <table id="basic-datatable" class="table table-striped dt-responsive w-100">
                            ...
                            <tr>
                                ...
                                <th>{{ __('content.person/organization') }}</th>
