                        ...
                        <div class="widget-sidebar">
                            ...
                            <div class="sidebar-widgets">
                                ...
                                <ul class="sidebar-category-list clearfix">
                                    <li><a href="{{ route('software-page.index') }}">{{ __('frontend.all') }}</a></li>
                                    @foreach ($software_count_categories as $software_count_category)
                                        <li class="@if ($software_count_category->software_category->category_name == $category->category_name) active @endif">
