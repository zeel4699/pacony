            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="form-heading">
                        <h2>Software Period Selection</h2>
                        <p>Select the renewal period for your service. Discounts for long-term rentals.</p>
                    </div>
                    <div class="step-one-form">
                        <form action="{{ route('add-to-cart-software-page.store_software') }}" method="POST">
                            @csrf
                            <input type="hidden" name="selection_price" value="@if ($software->period == "monthly") 0 @elseif ($software->period == "annually") 1 @else 2 @endif">
                            <input type="hidden" name="hidden_order_id" value="{{ $software->id }}">
                            <div class="row">
                                ...
                                @elseif ($software->monthly_price != null)
                                    <div class="col-lg-4">
                                ...
                                @elseif ($software->annually_price != null)
                                        <div class="col-lg-4">
                                ...
                                @endif
                                    @if ($software->period == "onetime")
                                        <div class="col-lg-4">
                                            <div class="step-one-price-box active" data-price-value="2">
                                                <h5>One Time</h5>
                                                <h2>
                                                    @if ($currency_position == "left") {{ $currency_symbol }}{{ number_format($software->onetime_price, $decimal_digit, $decimal_separator, $thousand_separator) }} @else {{ number_format($software->annually_price, $decimal_digit, $decimal_separator, $thousand_separator) }}{{ $currency_symbol }} @endif
                                                </h2>
                                            </div>
                                        </div>
                                    @elseif ($software->onetime_price != null)
                                        <div class="col-lg-4">
